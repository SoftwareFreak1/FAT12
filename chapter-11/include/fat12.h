...
typedef struct {
    ...
    /* Every value you later want configurable becomes one more member here.
       This struct is the extension point: add a field, read it in
       format_boot_sector, set it from the CLI. All other values stay
